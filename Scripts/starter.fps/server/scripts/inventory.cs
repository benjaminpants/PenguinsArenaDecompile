...
function ShapeBaseData::onUse(%this, %__unused)
{
	return 0;
}

function ShapeBaseData::onThrow(%this, %__unused, %amount)
{
	return 0;
}

function ShapeBaseData::onPickup(%this, %obj, %__unused, %amount)
{
	return 0;
}

function ShapeBaseData::onInventory(%this, %__unused, %value)
{
}
